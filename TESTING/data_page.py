...
class DataPage(Page) :
    def __init__(self, *args, **kwargs):
        ...
        self.menu_frame.grid(row=0, column=0, padx=(0,10), sticky="nsew")
        self.delete_data = ctk.CTkButton(self.menu_frame, text="Delete Data", command=self.delete_selected)
        self.delete_data.grid(row=1, column=0, padx=10, pady=20, sticky="nse")
        ...
        self.retrieve_data.grid(row=2, column=0, rowspan=2, padx=10, pady=10)
